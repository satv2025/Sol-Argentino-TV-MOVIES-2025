...
const peliculas = {
    ...
    app: {
        ...
        createdBy: "<div class='modal-createdBy' style='position: absolute; top: 74.38em; padding-left: 1.75em; font-size: 0.875em;'><span class='fcbprefix' style='color: #bcbcbc;'>Creado por:</span> <span class='fcbcontent'>Poppy Cogan</span></div>",
        fullcast: "<div class='fullcast' style='position: absolute; top: 75.95em; text-align: justify; padding-left: 1.75em; padding-right: 2.63em; font-size: 0.875em;'><span class='fcprefix' style='color: #bcbcbc;'>Elenco:</span> <span class='fccontent'>Emma Myers Zain Iqbal, Asha Banks, Raiko Gohara, Jude Morgan-Collie, Yali Topol Margalith, Yasmin Al-Khudhairi, Henry Ashton, Carla Woodcock, Mathew Baynton, Gary Beadle, Anna Maxwell Martin</span></div>", 
        fullscript: "<div class='fullscript' style='position: absolute; top: 78.34em; padding-left: 1.75em; padding-right: 1.75em; font-size: 0.875em;'><span class='fsprefix' style='color: #bcbcbc;'>Guión:</span> <span class='fscontent'>Poppy Cogan, Ruby Thomas, Zia Ahmed, Ajoke Ibironke</span></div>", 
        fullgenres: "<div class='fullgenres' style='position: absolute; top: 79.56em; padding-left: 1.75em; text-align: justify; padding-right: 2.63em; font-size: 0.875em;'><span class='fgprefix' style='color: #bcbcbc;'>Géneros:</span><span class='fgcontent'> Series dramáticas, De Gran Bretaña, Series basadas en libros, Series de adolescentes, Series de misterio</span></div>", 
        fulltitletype: "<div class='fulltitletype' style='position: absolute; top: 82.69em; text-align: justify; padding-left: 1.75em; padding-right: 2.63em; font-size: 0.875em;'><span class='fttprefix' style='color: #bcbcbc;'>Este titulo es:</span> <span class='fttcontent'> Íntimo, Sombrío, De suspenso</span></div>", 
        fullage: "<div class='fullage' style='position: absolute; top: 84.26em; text-align: justify; padding-right: 2.63em; padding-left: 1.75em; font-size: 0.875em;'><span class='faprefix' style='color: #bcbcbc;'>Clasificación por edad: </span> <span class='facontent'><span class='age'>16+</span> lenguaje inapropiado, drogas, violencia sexual</span> <span class='facontent2'>Apta para mayores de 16 años</span></div>",    
        seasons: `
