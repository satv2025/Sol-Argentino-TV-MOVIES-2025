...
const peliculas = {
    matiponcepeli: {
        ...
        createdBy: "<div class='modal-createdBy' style='position: absolute; top: 1190px; padding-left: 28px; font-size: 0.875em;'><span class='fcbprefix' style='color: #bcbcbc;'>Creado por:</span> <span class='fcbcontent'>Matías Ponce</span></div>",
        fullcast: "<div class='fullcast' style='position: absolute; top: 1213px; text-align: justify; padding-left: 28px; padding-right: 42px; font-size: 0.875em;'><span class='fcprefix' style='color: #bcbcbc;'>Elenco:</span> <span class='fccontent'>Matías Ponce, Santino Ponce, Indio Ponce, Antonella Ponce, Valeria Volpi, Julieta</span></div>",
        fullscript: "<div class='fullscript' style='position: absolute; top: 1239px; padding-left: 28px; padding-right: 28px; font-size: 0.875em;'><span class='fsprefix' style='color: #bcbcbc;'>Guión:</span> <span class='fscontent'>Matías Ponce</span></div>",
        fullgenres: "<div class='fullgenres' style='position: absolute; top: 1252px; padding-left: 28px; text-align: justify; padding-right: 42px; font-size: 0.875em;'><span class='fgprefix' style='color: #bcbcbc;'>Géneros:</span><span class='fgcontent'> Humor, humor absurdo, hackers, fama, grandes élites, paranoia, haters, YouTube</span></div>",
        fulltitletype: "<div class='fulltitletype' style='position: absolute; top: 1266px; text-align: justify; padding-left: 28px; padding-right: 42px; font-size: 0.875em;'><span class='fttprefix' style='color: #bcbcbc;'>Este titulo es:</span> <span class='fttcontent'> Original, delirante</span></div>",
        fullage: "<div class='fullage' style='position: absolute; top: 1285px; text-align: justify; padding-right: 42px; padding-left: 28px; font-size: 0.875em;'><span class='faprefix' style='color: #bcbcbc;'>Clasificación por edad: </span> <span class='facontent'><span class='age'>12+</span> adolescentes, adultos, lenguaje inapropiado, delirante</span> <span class='facontent2'>| Apta para mayores de 12 años</span></div>"
    },
    cienporcientolucha: {
        year: "2008-09",
        ...
        fullcast: "<div class='fullcast' style='position: absolute; top: 1388px; text-align: justify; padding-left: 32px; padding-right: 48px; font-size: 0.875em;'><span class='fcprefix' style='color: #bcbcbc;'>Elenco:</span> <span class='fccontent'>Maria Fernanda Neil, Carlos Kaspar, Daniel Garcilazo, Paulo Giardina, Gabriel Emanuelli, Norberto Adrián Fernandez, Marcelo Benítez, Miguel Ángel Wellington, Rubén Piuselli, Leonardo Montero, Eduardo Husni, Osvaldo Principi, Julio Mario Sibara (Turco Naím), Cecilia Bonelli, Delfina Gérez Bosco</span></div>",
        fullscript: "<div class='fullscript' style='position: absolute; top: 1456px; padding-left: 32px; padding-right: 32px; font-size: 0.875em;'><span class='fsprefix' style='color: #bcbcbc;'>Guión:</span> <span class='fscontent'>CineAR</span></div>",
        fullgenres: "<div class='fullgenres' style='position: absolute; top: 1484px; padding-left: 32px; text-align: justify; padding-right: 48px; font-size: 0.875em;'><span class='fgprefix' style='color: #bcbcbc;'>Géneros:</span><span class='fgcontent'> Humor, Lucha Libre, Luchas Clandestinas, Apuestas, Secuestros, Traiciones</span></div>",
        fulltitletype: "<div class='fulltitletype' style='position: absolute; top: 1512px; text-align: justify; padding-left: 32px; padding-right: 48px; font-size: 0.875em;'><span class='fttprefix' style='color: #bcbcbc;'>Este titulo es:</span> <span class='fttcontent'> Intenso, Íntimo, Delirante, Divertido</span></div>",
        fullage: "<div class='fullage' style='position: absolute; top: 1540px; text-align: justify; padding-right: 48px; padding-left: 32px; font-size: 0.875em;'><span class='faprefix' style='color: #bcbcbc;'>Clasificación por edad: </span> <span class='facontent'><span class='age'>12+</span> lenguaje inapropiado, daños físicos, humor absurdo</span> <span class='facontent2'>| Apta para mayores de 16 años</span></div>"
    },
    app: {
        year: "2024",
        ...
        fullcast: "<div class='fullcast' style='position: absolute; top: 1390px; text-align: justify; padding-left: 32px; padding-right: 48px; font-size: 0.875em;'><span class='fcprefix' style='color: #bcbcbc;'>Elenco:</span> <span class='fccontent'>Emma Myers Zain Iqbal, Asha Banks, Raiko Gohara, Jude Morgan-Collie, Yali Topol Margalith, Yasmin Al-Khudhairi, Henry Ashton, Carla Woodcock, Mathew Baynton, Gary Beadle, Anna Maxwell Martin</span></div>",
        fullscript: "<div class='fullscript' style='position: absolute; top: 1435px; padding-left: 32px; padding-right: 32px; font-size: 0.875em;'><span class='fsprefix' style='color: #bcbcbc;'>Guión:</span> <span class='fscontent'>Poppy Cogan, Ruby Thomas, Zia Ahmed, Ajoke Ibironke</span></div>",
        fullgenres: "<div class='fullgenres' style='position: absolute; top: 1456px; padding-left: 32px; text-align: justify; padding-right: 48px; font-size: 0.875em;'><span class='fgprefix' style='color: #bcbcbc;'>Géneros:</span><span class='fgcontent'> Series dramáticas, De Gran Bretaña, Series basadas en libros, Series de adolescentes, Series de misterio</span></div>",
        fulltitletype: "<div class='fulltitletype' style='position: absolute; top: 1488px; text-align: justify; padding-left: 32px; padding-right: 48px; font-size: 0.875em;'><span class='fttprefix' style='color: #bcbcbc;'>Este titulo es:</span> <span class='fttcontent'>  Íntimo, Sombrío, De suspenso</span></div>",
        fullage: "<div class='fullage' style='position: absolute; top: 1510px; text-align: justify; padding-right: 48px; padding-left: 32px; font-size: 0.875em;'><span class='faprefix' style='color: #bcbcbc;'>Clasificación por edad: </span> <span class='facontent'><span class='age'>16+</span> lenguaje inapropiado, drogas, violencia sexual</span> <span class='facontent2'>| Apta para mayores de 16 años</span></div>",
        seasons: `
