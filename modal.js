...
const peliculas = {
    matiponcepeli: {
        ...
        cast: "<strong>Elenco:</strong> Matias Ponce, Santino Ponce, Indio Ponce, <a id='scroll-to-about'>más</a>",
    ...
    cienporcientolucha: {
        ...
        cast: "<strong>Elenco:</strong> Maria Fernanda Neil, Carlos Kaspar, Daniel Garcilazo, <a id='scroll-to-about'>más</a>",
    ...
    app: {
        ...
        cast: "<strong>Elenco:</strong> Emma Myers, Zain Iqbal, Asha Banks, <a id='scroll-to-about'>más</a>",
...
document.getElementById('scroll-to-about').addEventListener('click', function(e) {
    // Evita el comportamiento por defecto del enlace (no cambia la URL)
    e.preventDefault();
