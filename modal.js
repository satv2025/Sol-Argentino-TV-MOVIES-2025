...
const peliculas = {
    matiponcepeli: {
        ...
        cast: "<strong>Elenco:</strong> Matias Ponce, Santino Ponce, Indio Ponce, <a class='scroll-btn' onclick='scrollToBottom()'>más</a>",
    ...
    cienporcientolucha: {
        ...
        cast: "<strong>Elenco:</strong> Maria Fernanda Neil, Carlos Kaspar, Daniel Garcilazo, <a class='scroll-btn' onclick='scrollToBottom()'>más</a>",
    ...
    app: {
        ...
        cast: "<strong>Elenco:</strong> Emma Myers, Zain Iqbal, Asha Banks, <a class='scroll-btn' onclick='scrollToBottom()'>más</a>",
