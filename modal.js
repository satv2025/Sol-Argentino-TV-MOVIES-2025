...
const peliculas = {
    matiponcepeli: {
        ...
        link: "#",
        createdBy: "<span class='modal-createdBy' style='position: absolute; top: 85em; padding-left: 2em;'><span class='fcbprefix'>Creado por:</span>  <span class='fcbcontent'>Matias Ponce</span></span>",
        fullcast: "<span class='fullcast' style='position: absolute; top: 86.8em; text-align: justify; padding-left: 2em; padding-right: 3em;'><span class='fcprefix'>Elenco:</span> <span class='fccontent'>Matias Ponce, Santino Ponce, Indio Ponce, Antonella Ponce, Valeria Volpi, Julieta</span></span>", 
        fullscript: "<span class='fullscript' style='position: absolute; top: 88.5em; padding-left: 2em; padding-right: 2em;'><span class='fsprefix'>Guión:</span> <span class='fscontent'>Matias Ponce</span></span>", 
        fullgenres: "<span class='fullgenres' style='position: absolute; top: 90.3em; padding-left: 2em; text-align: justify; padding-right: 3em;'><span class='fgprefix'>Géneros:</span><span class='fgcontent'> Humor, humor absurdo, hackers, fama, grandes élites, paranoia, haters, YouTube</span></span>", 
        fulltitletype: "<span class='fulltitletype' style='position: absolute; top: 92em; text-align: justify; padding-left: 2em; padding-right: 3em;'><span class='fttprefix'>Este titulo es:</span> <span class='fttcontent'> Original, delirante</span></span>", 
        fullage: "<span class='fullage' style='position: absolute; top: 93.85em; text-align: justify; padding-right: 3em; padding-left: 2em;'><span class='faprefix'>Clasificación por edad: </span> <span class='facontent'><span class='age'>12+</span> adolescentes, adultos, lenguaje inapropiado, delirante</span> <span class='facontent2'>Apta para mayores de 12 años</span></span>"    
    },
    cienporcientolucha: {
        year: "2008-09",
        ...
        link: "#",
        createdBy: "<span class='modal-createdBy' style='position: absolute; top: 85em; padding-left: 2em;'><span class='fcbprefix'>Creado por:</span>  <span class='fcbcontent'>Eduardo Husni</span></span>",
        fullcast: "<span class='fullcast' style='position: absolute; top: 86.8em; text-align: justify; padding-left: 2em; padding-right: 3em;'><span class='fcprefix'>Elenco:</span> <span class='fccontent'>Maria Fernanda Neil, Carlos Kaspar, Daniel Garcilazo, Paulo Giardina, Gabriel Emanuelli, Norberto Adrián Fernandez, Marcelo Benítez, Miguel Ángel Wellington, Rubén Piuselli, Leonardo Montero, Eduardo Husni, Osvaldo Principi, Julio Mario Sibara (Turco Naím), Cecilia Bonelli, Delfina Gérez Bosco</span></span>", 
        fullscript: "<span class='fullscript' style='position: absolute; top: 91em; padding-left: 2em; padding-right: 2em;'><span class='fsprefix'>Guión:</span> <span class='fscontent'>CineAR</span></span>", 
        fullgenres: "<span class='fullgenres' style='position: absolute; top: 92.8em; padding-left: 2em; text-align: justify; padding-right: 3em;'><span class='fgprefix'>Géneros:</span><span class='fgcontent'> Humor, Lucha Libre, Luchas Clandestinas, Apuestas, Secuestros, Traiciones</span></span>", 
        fulltitletype: "<span class='fulltitletype' style='position: absolute; top: 94.5em; text-align: justify; padding-left: 2em; padding-right: 3em;'><span class='fttprefix'>Este titulo es:</span> <span class='fttcontent'> Intenso, Íntimo, Delirante, Divertido</span></span>", 
        fullage: "<span class='fullage' style='position: absolute; top: 96.3em; text-align: justify; padding-right: 3em; padding-left: 2em;'><span class='faprefix'>Clasificación por edad: </span> <span class='facontent'><span class='age'>12+</span> lenguaje inapropiado, daños físicos, humor absurdo</span> <span class='facontent2'>Apta para mayores de 16 años</span></span>"
    },
    app: {
        year: "2024",
        ...
        link: "#",
        createdBy: "<span class='modal-createdBy' style='position: absolute; top: 85em; padding-left: 2em;'><span class='fcbprefix'>Creado por:</span> <span class='fcbcontent'>Poppy Cogan</span></span>",
        fullcast: "<span class='fullcast' style='position: absolute; top: 86.8em; text-align: justify; padding-left: 2em; padding-right: 3em;'><span class='fcprefix'>Elenco:</span> <span class='fccontent'>Emma Myers Zain Iqbal, Asha Banks, Raiko Gohara, Jude Morgan-Collie, Yali Topol Margalith, Yasmin Al-Khudhairi, Henry Ashton, Carla Woodcock, Mathew Baynton, Gary Beadle, Anna Maxwell Martin</span></span>", 
        fullscript: "<span class='fullscript' style='position: absolute; top: 89.7em; padding-left: 2em; padding-right: 2em;'><span class='fsprefix'>Guión:</span> <span class='fscontent'>Poppy Cogan, Ruby Thomas, Zia Ahmed, Ajoke Ibironke</span></span>", 
        fullgenres: "<span class='fullgenres' style='position: absolute; top: 91.5em; padding-left: 2em; text-align: justify; padding-right: 3em;'><span class='fgprefix'>Géneros:</span><span class='fgcontent'> Series dramáticas, De Gran Bretaña, Series basadas en libros, Series de adolescentes, Series de misterio</span></span>", 
        fulltitletype: "<span class='fulltitletype' style='position: absolute; top: 94.5em; text-align: justify; padding-left: 2em; padding-right: 3em;'><span class='fttprefix'>Este titulo es:</span> <span class='fttcontent'> Íntimo, Sombrío, De suspenso</span></span>", 
        fullage: "<span class='fullage' style='position: absolute; top: 96.3em; text-align: justify; padding-right: 3em; padding-left: 2em;'><span class='faprefix'>Clasificación por edad: </span> <span class='facontent'><span class='age'>16+</span> lenguaje inapropiado, drogas, violencia sexual</span> <span class='facontent2'>Apta para mayores de 16 años</span></span>",    
        seasons: `
