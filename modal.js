...
const peliculas = {
    matiponcepeli: {
        ...
        title: "<p class='about'>Acerca de</p> <strong class='titulo'></span> <strong class='titulo'>Matias Ponce - La Película</strong>",
    ...
    cienporcientolucha: {
        ...
        title: "<p class='about'>Acerca de</p> <strong class='titulo'> 100%Lucha - Las Películas</strong>",
    ...
    app: {
        ...
        title: "<p class='about'>Acerca de</p> <strong class='titulo'> Asesinato Para Principiantes</strong>",
