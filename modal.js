...
const peliculas = {
    matiponcepeli: {
        ...
        cast: "<strong>Elenco:</strong> Matias Ponce, Santino Ponce, Indio Ponce, <a id='#about'>más</a>",
    ...
    cienporcientolucha: {
        ...
        cast: "<strong>Elenco:</strong> Maria Fernanda Neil, Carlos Kaspar, Daniel Garcilazo, <a id='#about'>más</a>",
    ...
    app: {
        ...
        cast: "<strong>Elenco:</strong> Emma Myers, Zain Iqbal, Asha Banks, <a id='#about'>más</a>",
